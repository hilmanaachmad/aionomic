...
/**
 * Specifies methods used to obtain and modify T052u related information
 * which is stored in the database.
 */
@Repository("sap_master.T052uDao")
public class T052uDao extends WMGenericDaoImpl<T052u, T052uId> {
