...
/**
 * Specifies methods used to obtain and modify T023 related information
 * which is stored in the database.
 */
@Repository("sap_master.T023Dao")
public class T023Dao extends WMGenericDaoImpl<T023, String> {
