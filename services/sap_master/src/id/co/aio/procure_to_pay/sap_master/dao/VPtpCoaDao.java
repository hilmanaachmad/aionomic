...
/**
 * Specifies methods used to obtain and modify VPtpCoa related information
 * which is stored in the database.
 */
@Repository("sap_master.VPtpCoaDao")
public class VPtpCoaDao extends WMGenericDaoImpl<VPtpCoa, VPtpCoaId> {
