...
/**
 * Specifies methods used to obtain and modify Skat related information
 * which is stored in the database.
 */
@Repository("sap_master.SkatDao")
public class SkatDao extends WMGenericDaoImpl<Skat, SkatId> {
