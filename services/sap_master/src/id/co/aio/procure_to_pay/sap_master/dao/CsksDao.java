...
/**
 * Specifies methods used to obtain and modify Csks related information
 * which is stored in the database.
 */
@Repository("sap_master.CsksDao")
public class CsksDao extends WMGenericDaoImpl<Csks, CsksId> {
