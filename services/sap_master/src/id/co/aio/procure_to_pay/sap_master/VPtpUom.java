...
/**
 * VPtpUom generated by WaveMaker Studio.
 */
@Entity
@Table(name = "`v_ptp_uom`")
@IdClass(VPtpUomId.class)
public class VPtpUom implements Serializable {
    ...
    @Id
    @Column(name = "`uom_char_10`", nullable = true, length = 10)
    ...
    @Id
    @Column(name = "`uom`", nullable = false, length = 3)
    ...
    @Id
    @Column(name = "`uom_char_3`", nullable = false, length = 3)
    ...
    @Id
    @Column(name = "`uom_char_30`", nullable = true, length = 30)
    ...
    @Id
    @Column(name = "`uom_char_6`", nullable = false, length = 6)
