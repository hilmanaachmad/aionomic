...
/**
 * Specifies methods used to obtain and modify Cskt related information
 * which is stored in the database.
 */
@Repository("sap_master.CsktDao")
public class CsktDao extends WMGenericDaoImpl<Cskt, CsktId> {
