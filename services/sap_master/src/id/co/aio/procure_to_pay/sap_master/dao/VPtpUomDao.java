...
/**
 * Specifies methods used to obtain and modify VPtpUom related information
 * which is stored in the database.
 */
@Repository("sap_master.VPtpUomDao")
public class VPtpUomDao extends WMGenericDaoImpl<VPtpUom, VPtpUomId> {
