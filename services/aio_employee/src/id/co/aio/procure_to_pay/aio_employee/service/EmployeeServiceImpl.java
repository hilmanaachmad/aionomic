...
import id.co.aio.procure_to_pay.aio_employee.Employee;
 ...
 * @see Employee
 */
@Service("aio_employee.EmployeeService")
@Validated
@EntityService(entityClass = Employee.class, serviceId = "aio_employee")
public class EmployeeServiceImpl implements EmployeeService {
    ...
    @Autowired
    @Qualifier("aio_employee.EmployeeDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service aio_employee for table Employee to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service aio_employee for table Employee to {} format", options.getExportType());
