...
import id.co.aio.procure_to_pay.aio_employee.service.EmployeeService;
 ...
 * @see Employee
 */
@RestController("aio_employee.EmployeeController")
@Api(value = "EmployeeController", description = "Exposes APIs to work with Employee resource.")
@RequestMapping("/aio_employee/Employee")
public class EmployeeController {

    private static final Logger LOGGER = LoggerFactory.getLogger(EmployeeController.class);

    @Autowired
	@Qualifier("aio_employee.EmployeeService")
