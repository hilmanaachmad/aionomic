...
/**
 * Specifies methods used to obtain and modify TlMsCategory related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsCategoryDao")
public class TlMsCategoryDao extends WMGenericDaoImpl<TlMsCategory, Integer> {
