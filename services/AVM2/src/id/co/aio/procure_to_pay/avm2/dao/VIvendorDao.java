...
/**
 * Specifies methods used to obtain and modify VIvendor related information
 * which is stored in the database.
 */
@Repository("AVM2.VIvendorDao")
public class VIvendorDao extends WMGenericDaoImpl<VIvendor, String> {
