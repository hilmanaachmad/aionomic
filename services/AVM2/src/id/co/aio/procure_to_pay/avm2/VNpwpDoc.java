...
/**
 * VNpwpDoc generated by WaveMaker Studio.
 */
@Entity
@Table(name = "`v_npwpDoc`")
public class VNpwpDoc implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VNpwpDoc)) return false;
        final VNpwpDoc vnpwpDoc = (VNpwpDoc) o;
        return Objects.equals(getAbIdnt(), vnpwpDoc.getAbIdnt());
    }
