...
/**
 * Specifies methods used to obtain and modify TlTrAgEntity related information
 * which is stored in the database.
 */
@Repository("AVM2.TlTrAgEntityDao")
public class TlTrAgEntityDao extends WMGenericDaoImpl<TlTrAgEntity, Integer> {
