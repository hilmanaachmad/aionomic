...
/**
 * TlMsAcnk generated by WaveMaker Studio.
 */
@Entity
@Table(name = "`tl_ms_acnk`")
public class TlMsAcnk implements Serializable {
    ...
    @Column(name = "`ab_ccy`", nullable = true, length = 4)
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TlMsAcnk)) return false;
        final TlMsAcnk tlMsAcnk = (TlMsAcnk) o;
        return Objects.equals(getAbIdng(), tlMsAcnk.getAbIdng());
    }
