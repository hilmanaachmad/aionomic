...
/**
 * Specifies methods used to obtain and modify TlMsPuonEntity related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsPuonEntityDao")
public class TlMsPuonEntityDao extends WMGenericDaoImpl<TlMsPuonEntity, Integer> {
