...
/**
 * Specifies methods used to obtain and modify TlTrRenk related information
 * which is stored in the database.
 */
@Repository("AVM2.TlTrRenkDao")
public class TlTrRenkDao extends WMGenericDaoImpl<TlTrRenk, Integer> {
