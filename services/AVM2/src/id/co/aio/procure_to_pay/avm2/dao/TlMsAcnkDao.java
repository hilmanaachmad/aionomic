...
/**
 * Specifies methods used to obtain and modify TlMsAcnk related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsAcnkDao")
public class TlMsAcnkDao extends WMGenericDaoImpl<TlMsAcnk, Integer> {
