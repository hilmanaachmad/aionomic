...
/**
 * VRegIndo generated by WaveMaker Studio.
 */
@Entity
@Table(name = "`v_regIndo`")
public class VRegIndo implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VRegIndo)) return false;
        final VRegIndo vregIndo = (VRegIndo) o;
        return Objects.equals(getAbCoey(), vregIndo.getAbCoey());
    }
