...
/**
 * Specifies methods used to obtain and modify TlMsBa related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsBaDao")
public class TlMsBaDao extends WMGenericDaoImpl<TlMsBa, Integer> {
