...
/**
 * VCertiDom generated by WaveMaker Studio.
 */
@Entity
@Table(name = "`v_certiDom`")
public class VCertiDom implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VCertiDom)) return false;
        final VCertiDom vcertiDom = (VCertiDom) o;
        return Objects.equals(getAbIdnt(), vcertiDom.getAbIdnt());
    }
