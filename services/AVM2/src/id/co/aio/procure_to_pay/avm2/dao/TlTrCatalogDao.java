...
/**
 * Specifies methods used to obtain and modify TlTrCatalog related information
 * which is stored in the database.
 */
@Repository("AVM2.TlTrCatalogDao")
public class TlTrCatalogDao extends WMGenericDaoImpl<TlTrCatalog, Integer> {
