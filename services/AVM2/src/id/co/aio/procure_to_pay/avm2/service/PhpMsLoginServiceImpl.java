 ...
 * @see PhpMsLogin
 */
@Service("AVM2.PhpMsLoginService")
@Validated
@EntityService(entityClass = PhpMsLogin.class, serviceId = "AVM2")
public class PhpMsLoginServiceImpl implements PhpMsLoginService {
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service AVM2 for table PhpMsLogin to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service AVM2 for table PhpMsLogin to {} format", options.getExportType());
