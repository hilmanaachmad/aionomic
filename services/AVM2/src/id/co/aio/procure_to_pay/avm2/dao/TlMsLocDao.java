...
/**
 * Specifies methods used to obtain and modify TlMsLoc related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsLocDao")
public class TlMsLocDao extends WMGenericDaoImpl<TlMsLoc, Long> {
