...
/**
 * Specifies methods used to obtain and modify TlMsAcnkTemp related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsAcnkTempDao")
public class TlMsAcnkTempDao extends WMGenericDaoImpl<TlMsAcnkTemp, Integer> {
