...
/**
 * Specifies methods used to obtain and modify VSupDoc related information
 * which is stored in the database.
 */
@Repository("AVM2.VSupDocDao")
public class VSupDocDao extends WMGenericDaoImpl<VSupDoc, Integer> {
