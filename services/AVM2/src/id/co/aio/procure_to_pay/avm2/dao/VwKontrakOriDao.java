...
/**
 * Specifies methods used to obtain and modify VwKontrakOri related information
 * which is stored in the database.
 */
@Repository("AVM2.VwKontrakOriDao")
public class VwKontrakOriDao extends WMGenericDaoImpl<VwKontrakOri, String> {
