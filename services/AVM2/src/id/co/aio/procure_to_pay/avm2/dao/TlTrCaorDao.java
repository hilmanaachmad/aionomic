...
/**
 * Specifies methods used to obtain and modify TlTrCaor related information
 * which is stored in the database.
 */
@Repository("AVM2.TlTrCaorDao")
public class TlTrCaorDao extends WMGenericDaoImpl<TlTrCaor, Integer> {
