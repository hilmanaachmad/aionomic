...
/**
 * Specifies methods used to obtain and modify VRegIndo related information
 * which is stored in the database.
 */
@Repository("AVM2.VRegIndoDao")
public class VRegIndoDao extends WMGenericDaoImpl<VRegIndo, String> {
