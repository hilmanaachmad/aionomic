...
/**
 * Specifies methods used to obtain and modify VDataBank related information
 * which is stored in the database.
 */
@Repository("AVM2.VDataBankDao")
public class VDataBankDao extends WMGenericDaoImpl<VDataBank, Integer> {
