...
/**
 * Specifies methods used to obtain and modify TlTrAg related information
 * which is stored in the database.
 */
@Repository("AVM2.TlTrAgDao")
public class TlTrAgDao extends WMGenericDaoImpl<TlTrAg, Integer> {
