...
/**
 * Specifies methods used to obtain and modify TlMsCo related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsCoDao")
public class TlMsCoDao extends WMGenericDaoImpl<TlMsCo, String> {
