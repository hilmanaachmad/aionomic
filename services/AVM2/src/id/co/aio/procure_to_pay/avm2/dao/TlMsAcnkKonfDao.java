...
/**
 * Specifies methods used to obtain and modify TlMsAcnkKonf related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsAcnkKonfDao")
public class TlMsAcnkKonfDao extends WMGenericDaoImpl<TlMsAcnkKonf, Integer> {
