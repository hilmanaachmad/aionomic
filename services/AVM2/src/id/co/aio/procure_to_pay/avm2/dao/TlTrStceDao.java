...
/**
 * Specifies methods used to obtain and modify TlTrStce related information
 * which is stored in the database.
 */
@Repository("AVM2.TlTrStceDao")
public class TlTrStceDao extends WMGenericDaoImpl<TlTrStce, TlTrStceId> {
