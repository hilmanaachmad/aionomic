...
/**
 * Specifies methods used to obtain and modify TlTrSk related information
 * which is stored in the database.
 */
@Repository("AVM2.TlTrSkDao")
public class TlTrSkDao extends WMGenericDaoImpl<TlTrSk, Integer> {
