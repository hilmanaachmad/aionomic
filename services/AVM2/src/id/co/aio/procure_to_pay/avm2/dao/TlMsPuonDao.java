...
/**
 * Specifies methods used to obtain and modify TlMsPuon related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsPuonDao")
public class TlMsPuonDao extends WMGenericDaoImpl<TlMsPuon, Integer> {
