...
/**
 * Specifies methods used to obtain and modify BankData related information
 * which is stored in the database.
 */
@Repository("AVM2.BankDataDao")
public class BankDataDao extends WMGenericDaoImpl<BankData, BankDataId> {
