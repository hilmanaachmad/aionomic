...
/**
 * Specifies methods used to obtain and modify TlMsLo related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsLoDao")
public class TlMsLoDao extends WMGenericDaoImpl<TlMsLo, String> {
