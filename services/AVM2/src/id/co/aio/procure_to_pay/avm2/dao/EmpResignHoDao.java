...
/**
 * Specifies methods used to obtain and modify EmpResignHo related information
 * which is stored in the database.
 */
@Repository("AVM2.EmpResignHoDao")
public class EmpResignHoDao extends WMGenericDaoImpl<EmpResignHo, EmpResignHoId> {
