...
/**
 * Specifies methods used to obtain and modify TlMsAcnkSmi3 related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsAcnkSmi3Dao")
public class TlMsAcnkSmi3Dao extends WMGenericDaoImpl<TlMsAcnkSmi3, String> {
