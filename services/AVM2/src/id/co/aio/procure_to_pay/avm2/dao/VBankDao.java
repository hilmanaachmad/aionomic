...
/**
 * Specifies methods used to obtain and modify VBank related information
 * which is stored in the database.
 */
@Repository("AVM2.VBankDao")
public class VBankDao extends WMGenericDaoImpl<VBank, VBankId> {
