...
/**
 * Specifies methods used to obtain and modify TlMsPuonTemp related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsPuonTempDao")
public class TlMsPuonTempDao extends WMGenericDaoImpl<TlMsPuonTemp, Integer> {
