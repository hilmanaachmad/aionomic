...
/**
 * Specifies methods used to obtain and modify TlMsLocNew related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsLocNewDao")
public class TlMsLocNewDao extends WMGenericDaoImpl<TlMsLocNew, Integer> {
