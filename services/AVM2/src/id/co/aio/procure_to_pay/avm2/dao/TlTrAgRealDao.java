...
/**
 * Specifies methods used to obtain and modify TlTrAgReal related information
 * which is stored in the database.
 */
@Repository("AVM2.TlTrAgRealDao")
public class TlTrAgRealDao extends WMGenericDaoImpl<TlTrAgReal, Integer> {
