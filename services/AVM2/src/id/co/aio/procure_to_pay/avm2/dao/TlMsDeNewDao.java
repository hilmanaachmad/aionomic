...
/**
 * Specifies methods used to obtain and modify TlMsDeNew related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsDeNewDao")
public class TlMsDeNewDao extends WMGenericDaoImpl<TlMsDeNew, Integer> {
