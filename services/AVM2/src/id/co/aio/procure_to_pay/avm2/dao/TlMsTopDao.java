...
/**
 * Specifies methods used to obtain and modify TlMsTop related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsTopDao")
public class TlMsTopDao extends WMGenericDaoImpl<TlMsTop, Integer> {
