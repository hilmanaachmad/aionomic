...
/**
 * Specifies methods used to obtain and modify TlMsTyon related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsTyonDao")
public class TlMsTyonDao extends WMGenericDaoImpl<TlMsTyon, Integer> {
