...
/**
 * Specifies methods used to obtain and modify TlMsDo related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsDoDao")
public class TlMsDoDao extends WMGenericDaoImpl<TlMsDo, Integer> {
