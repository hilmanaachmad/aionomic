...
/**
 * Specifies methods used to obtain and modify VCertiDom related information
 * which is stored in the database.
 */
@Repository("AVM2.VCertiDomDao")
public class VCertiDomDao extends WMGenericDaoImpl<VCertiDom, Integer> {
