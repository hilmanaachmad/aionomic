...
/**
 * Specifies methods used to obtain and modify VSppkpDoc related information
 * which is stored in the database.
 */
@Repository("AVM2.VSppkpDocDao")
public class VSppkpDocDao extends WMGenericDaoImpl<VSppkpDoc, Integer> {
