...
/**
 * Specifies methods used to obtain and modify VNpwpDoc related information
 * which is stored in the database.
 */
@Repository("AVM2.VNpwpDocDao")
public class VNpwpDocDao extends WMGenericDaoImpl<VNpwpDoc, Integer> {
