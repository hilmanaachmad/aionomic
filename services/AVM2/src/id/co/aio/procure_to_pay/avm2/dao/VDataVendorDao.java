...
/**
 * Specifies methods used to obtain and modify VDataVendor related information
 * which is stored in the database.
 */
@Repository("AVM2.VDataVendorDao")
public class VDataVendorDao extends WMGenericDaoImpl<VDataVendor, String> {
