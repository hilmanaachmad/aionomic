...
/**
 * Specifies methods used to obtain and modify TlMsNotifEmail related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsNotifEmailDao")
public class TlMsNotifEmailDao extends WMGenericDaoImpl<TlMsNotifEmail, Integer> {
