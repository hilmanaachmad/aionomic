...
/**
 * Specifies methods used to obtain and modify TlMsVeKonf related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsVeKonfDao")
public class TlMsVeKonfDao extends WMGenericDaoImpl<TlMsVeKonf, String> {
