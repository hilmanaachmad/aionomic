...
/**
 * Specifies methods used to obtain and modify VDataTaxLocal related information
 * which is stored in the database.
 */
@Repository("AVM2.VDataTaxLocalDao")
public class VDataTaxLocalDao extends WMGenericDaoImpl<VDataTaxLocal, Integer> {
