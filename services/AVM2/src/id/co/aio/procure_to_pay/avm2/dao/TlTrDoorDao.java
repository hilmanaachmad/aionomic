...
/**
 * Specifies methods used to obtain and modify TlTrDoor related information
 * which is stored in the database.
 */
@Repository("AVM2.TlTrDoorDao")
public class TlTrDoorDao extends WMGenericDaoImpl<TlTrDoor, Integer> {
