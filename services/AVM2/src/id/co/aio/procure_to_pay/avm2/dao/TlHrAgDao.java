...
/**
 * Specifies methods used to obtain and modify TlHrAg related information
 * which is stored in the database.
 */
@Repository("AVM2.TlHrAgDao")
public class TlHrAgDao extends WMGenericDaoImpl<TlHrAg, Integer> {
