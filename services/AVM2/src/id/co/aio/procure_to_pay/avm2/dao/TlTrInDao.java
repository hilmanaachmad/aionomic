...
/**
 * Specifies methods used to obtain and modify TlTrIn related information
 * which is stored in the database.
 */
@Repository("AVM2.TlTrInDao")
public class TlTrInDao extends WMGenericDaoImpl<TlTrIn, Integer> {
