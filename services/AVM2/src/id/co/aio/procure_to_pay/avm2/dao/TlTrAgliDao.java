...
/**
 * Specifies methods used to obtain and modify TlTrAgli related information
 * which is stored in the database.
 */
@Repository("AVM2.TlTrAgliDao")
public class TlTrAgliDao extends WMGenericDaoImpl<TlTrAgli, TlTrAgliId> {
