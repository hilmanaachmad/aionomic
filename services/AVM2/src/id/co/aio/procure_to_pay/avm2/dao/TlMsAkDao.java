...
/**
 * Specifies methods used to obtain and modify TlMsAk related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsAkDao")
public class TlMsAkDao extends WMGenericDaoImpl<TlMsAk, String> {
