...
/**
 * Specifies methods used to obtain and modify TlMsForgotUser related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsForgotUserDao")
public class TlMsForgotUserDao extends WMGenericDaoImpl<TlMsForgotUser, Integer> {
