...
/**
 * Specifies methods used to obtain and modify TlMsTa related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsTaDao")
public class TlMsTaDao extends WMGenericDaoImpl<TlMsTa, Integer> {
