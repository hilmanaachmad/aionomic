...
/**
 * Specifies methods used to obtain and modify TlMsPuonFina related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsPuonFinaDao")
public class TlMsPuonFinaDao extends WMGenericDaoImpl<TlMsPuonFina, Double> {
