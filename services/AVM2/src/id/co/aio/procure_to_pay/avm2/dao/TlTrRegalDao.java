...
/**
 * Specifies methods used to obtain and modify TlTrRegal related information
 * which is stored in the database.
 */
@Repository("AVM2.TlTrRegalDao")
public class TlTrRegalDao extends WMGenericDaoImpl<TlTrRegal, Integer> {
