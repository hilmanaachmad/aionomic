...
/**
 * TlTrDoor generated by WaveMaker Studio.
 */
@Entity
@Table(name = "`tl_tr_door`")
public class TlTrDoor implements Serializable {
    ...
    @Column(name = "`ab_coorsa`", nullable = true, length = 255)
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TlTrDoor)) return false;
        final TlTrDoor tlTrDoor = (TlTrDoor) o;
        return Objects.equals(getAbIdnt(), tlTrDoor.getAbIdnt());
    }
