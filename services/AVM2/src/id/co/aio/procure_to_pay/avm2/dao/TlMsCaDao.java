...
/**
 * Specifies methods used to obtain and modify TlMsCa related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsCaDao")
public class TlMsCaDao extends WMGenericDaoImpl<TlMsCa, Integer> {
