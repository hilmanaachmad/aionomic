...
/**
 * Specifies methods used to obtain and modify VVendorMiro related information
 * which is stored in the database.
 */
@Repository("AVM2.VVendorMiroDao")
public class VVendorMiroDao extends WMGenericDaoImpl<VVendorMiro, VVendorMiroId> {
