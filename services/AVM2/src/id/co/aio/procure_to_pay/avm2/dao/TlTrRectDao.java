...
/**
 * Specifies methods used to obtain and modify TlTrRect related information
 * which is stored in the database.
 */
@Repository("AVM2.TlTrRectDao")
public class TlTrRectDao extends WMGenericDaoImpl<TlTrRect, Integer> {
