...
/**
 * Specifies methods used to obtain and modify TableVendor related information
 * which is stored in the database.
 */
@Repository("AVM2.TableVendorDao")
public class TableVendorDao extends WMGenericDaoImpl<TableVendor, Integer> {
