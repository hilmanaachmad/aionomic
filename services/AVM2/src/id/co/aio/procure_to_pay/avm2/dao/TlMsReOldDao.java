...
/**
 * Specifies methods used to obtain and modify TlMsReOld related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsReOldDao")
public class TlMsReOldDao extends WMGenericDaoImpl<TlMsReOld, String> {
