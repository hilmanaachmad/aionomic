...
/**
 * Specifies methods used to obtain and modify VExemptionDoc related information
 * which is stored in the database.
 */
@Repository("AVM2.VExemptionDocDao")
public class VExemptionDocDao extends WMGenericDaoImpl<VExemptionDoc, Integer> {
