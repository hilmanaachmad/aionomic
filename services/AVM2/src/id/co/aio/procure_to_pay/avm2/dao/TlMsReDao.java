...
/**
 * Specifies methods used to obtain and modify TlMsRe related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsReDao")
public class TlMsReDao extends WMGenericDaoImpl<TlMsRe, TlMsReId> {
