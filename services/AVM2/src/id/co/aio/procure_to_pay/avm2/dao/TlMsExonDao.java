...
/**
 * Specifies methods used to obtain and modify TlMsExon related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsExonDao")
public class TlMsExonDao extends WMGenericDaoImpl<TlMsExon, Integer> {
