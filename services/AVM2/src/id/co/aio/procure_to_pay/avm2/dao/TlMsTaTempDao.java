...
/**
 * Specifies methods used to obtain and modify TlMsTaTemp related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsTaTempDao")
public class TlMsTaTempDao extends WMGenericDaoImpl<TlMsTaTemp, Integer> {
