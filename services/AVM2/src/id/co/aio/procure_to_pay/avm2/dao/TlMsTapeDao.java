...
/**
 * Specifies methods used to obtain and modify TlMsTape related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsTapeDao")
public class TlMsTapeDao extends WMGenericDaoImpl<TlMsTape, Integer> {
