...
/**
 * Specifies methods used to obtain and modify VwListagree related information
 * which is stored in the database.
 */
@Repository("AVM2.VwListagreeDao")
public class VwListagreeDao extends WMGenericDaoImpl<VwListagree, Long> {
