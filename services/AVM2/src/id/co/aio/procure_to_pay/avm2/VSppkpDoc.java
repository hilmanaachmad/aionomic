...
/**
 * VSppkpDoc generated by WaveMaker Studio.
 */
@Entity
@Table(name = "`v_sppkpDoc`")
public class VSppkpDoc implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VSppkpDoc)) return false;
        final VSppkpDoc vsppkpDoc = (VSppkpDoc) o;
        return Objects.equals(getAbIdnt(), vsppkpDoc.getAbIdnt());
    }
