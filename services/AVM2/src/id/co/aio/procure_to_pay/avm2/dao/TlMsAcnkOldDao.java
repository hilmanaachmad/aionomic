...
/**
 * Specifies methods used to obtain and modify TlMsAcnkOld related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsAcnkOldDao")
public class TlMsAcnkOldDao extends WMGenericDaoImpl<TlMsAcnkOld, Integer> {
