...
/**
 * Specifies methods used to obtain and modify TlMsEm related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsEmDao")
public class TlMsEmDao extends WMGenericDaoImpl<TlMsEm, Integer> {
