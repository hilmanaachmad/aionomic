...
/**
 * Specifies methods used to obtain and modify TlMsEmTemp related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsEmTempDao")
public class TlMsEmTempDao extends WMGenericDaoImpl<TlMsEmTemp, Integer> {
