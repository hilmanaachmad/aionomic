...
/**
 * Specifies methods used to obtain and modify TlTaTemp related information
 * which is stored in the database.
 */
@Repository("AVM2.TlTaTempDao")
public class TlTaTempDao extends WMGenericDaoImpl<TlTaTemp, Integer> {
