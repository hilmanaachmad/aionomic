...
/**
 * Specifies methods used to obtain and modify TlMsCc related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsCcDao")
public class TlMsCcDao extends WMGenericDaoImpl<TlMsCc, String> {
