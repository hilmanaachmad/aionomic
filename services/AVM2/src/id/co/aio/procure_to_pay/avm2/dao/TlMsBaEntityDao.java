...
/**
 * Specifies methods used to obtain and modify TlMsBaEntity related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsBaEntityDao")
public class TlMsBaEntityDao extends WMGenericDaoImpl<TlMsBaEntity, String> {
