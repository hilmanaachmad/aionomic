...
/**
 * Specifies methods used to obtain and modify VwGratifikasi related information
 * which is stored in the database.
 */
@Repository("AVM2.VwGratifikasiDao")
public class VwGratifikasiDao extends WMGenericDaoImpl<VwGratifikasi, String> {
