...
/**
 * Specifies methods used to obtain and modify TlMsLoEntity related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsLoEntityDao")
public class TlMsLoEntityDao extends WMGenericDaoImpl<TlMsLoEntity, String> {
