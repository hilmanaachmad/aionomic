...
/**
 * Specifies methods used to obtain and modify TlMsDe related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsDeDao")
public class TlMsDeDao extends WMGenericDaoImpl<TlMsDe, Long> {
