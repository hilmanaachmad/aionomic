...
/**
 * Specifies methods used to obtain and modify TlTrDoak related information
 * which is stored in the database.
 */
@Repository("AVM2.TlTrDoakDao")
public class TlTrDoakDao extends WMGenericDaoImpl<TlTrDoak, Integer> {
