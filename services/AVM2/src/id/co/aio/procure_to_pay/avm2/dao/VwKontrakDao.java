...
/**
 * Specifies methods used to obtain and modify VwKontrak related information
 * which is stored in the database.
 */
@Repository("AVM2.VwKontrakDao")
public class VwKontrakDao extends WMGenericDaoImpl<VwKontrak, String> {
