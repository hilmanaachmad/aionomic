...
/**
 * Specifies methods used to obtain and modify TlMsEmDel related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsEmDelDao")
public class TlMsEmDelDao extends WMGenericDaoImpl<TlMsEmDel, Integer> {
