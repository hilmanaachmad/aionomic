...
/**
 * VPic generated by WaveMaker Studio.
 */
@Entity
@Table(name = "`v_PIC`")
public class VPic implements Serializable {
    ...
    @Column(name = "`ab_mobile_phone`", nullable = true, length = 15)
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VPic)) return false;
        final VPic vpic = (VPic) o;
        return Objects.equals(getAbIdil(), vpic.getAbIdil());
    }
