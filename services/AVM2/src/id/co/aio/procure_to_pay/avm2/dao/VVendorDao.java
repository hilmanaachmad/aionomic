...
/**
 * Specifies methods used to obtain and modify VVendor related information
 * which is stored in the database.
 */
@Repository("AVM2.VVendorDao")
public class VVendorDao extends WMGenericDaoImpl<VVendor, String> {
