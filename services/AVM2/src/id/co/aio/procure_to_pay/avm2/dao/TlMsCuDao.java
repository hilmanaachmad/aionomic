...
/**
 * Specifies methods used to obtain and modify TlMsCu related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsCuDao")
public class TlMsCuDao extends WMGenericDaoImpl<TlMsCu, Integer> {
