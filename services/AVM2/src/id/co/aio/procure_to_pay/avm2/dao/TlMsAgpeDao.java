...
/**
 * Specifies methods used to obtain and modify TlMsAgpe related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsAgpeDao")
public class TlMsAgpeDao extends WMGenericDaoImpl<TlMsAgpe, Integer> {
