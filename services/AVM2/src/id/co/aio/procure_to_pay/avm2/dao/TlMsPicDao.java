...
/**
 * Specifies methods used to obtain and modify TlMsPic related information
 * which is stored in the database.
 */
@Repository("AVM2.TlMsPicDao")
public class TlMsPicDao extends WMGenericDaoImpl<TlMsPic, Integer> {
