...
/**
 * Specifies methods used to obtain and modify VBudgetDetails related information
 * which is stored in the database.
 */
@Repository("aio_ptp.VBudgetDetailsDao")
public class VBudgetDetailsDao extends WMGenericDaoImpl<VBudgetDetails, Integer> {
