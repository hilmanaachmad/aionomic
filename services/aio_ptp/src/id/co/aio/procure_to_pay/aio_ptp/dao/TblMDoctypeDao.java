...
/**
 * Specifies methods used to obtain and modify TblMDoctype related information
 * which is stored in the database.
 */
@Repository("aio_ptp.TblMDoctypeDao")
public class TblMDoctypeDao extends WMGenericDaoImpl<TblMDoctype, Integer> {
