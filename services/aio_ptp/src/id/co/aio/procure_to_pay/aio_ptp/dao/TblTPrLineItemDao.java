...
/**
 * Specifies methods used to obtain and modify TblTPrLineItem related information
 * which is stored in the database.
 */
@Repository("aio_ptp.TblTPrLineItemDao")
public class TblTPrLineItemDao extends WMGenericDaoImpl<TblTPrLineItem, Integer> {
