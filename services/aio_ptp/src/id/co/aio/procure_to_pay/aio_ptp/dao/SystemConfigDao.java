...
/**
 * Specifies methods used to obtain and modify SystemConfig related information
 * which is stored in the database.
 */
@Repository("aio_ptp.SystemConfigDao")
public class SystemConfigDao extends WMGenericDaoImpl<SystemConfig, Integer> {
