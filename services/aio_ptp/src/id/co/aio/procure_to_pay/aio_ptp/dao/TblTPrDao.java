...
/**
 * Specifies methods used to obtain and modify TblTPr related information
 * which is stored in the database.
 */
@Repository("aio_ptp.TblTPrDao")
public class TblTPrDao extends WMGenericDaoImpl<TblTPr, Integer> {
