...
/**
 * Specifies methods used to obtain and modify TblTGrLineItem related information
 * which is stored in the database.
 */
@Repository("aio_ptp.TblTGrLineItemDao")
public class TblTGrLineItemDao extends WMGenericDaoImpl<TblTGrLineItem, Integer> {
