...
/**
 * Specifies methods used to obtain and modify TblMRole related information
 * which is stored in the database.
 */
@Repository("aio_ptp.TblMRoleDao")
public class TblMRoleDao extends WMGenericDaoImpl<TblMRole, Integer> {
