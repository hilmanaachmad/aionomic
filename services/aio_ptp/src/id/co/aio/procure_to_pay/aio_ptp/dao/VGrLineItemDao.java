...
/**
 * Specifies methods used to obtain and modify VGrLineItem related information
 * which is stored in the database.
 */
@Repository("aio_ptp.VGrLineItemDao")
public class VGrLineItemDao extends WMGenericDaoImpl<VGrLineItem, Integer> {
