...
/**
 * Specifies methods used to obtain and modify VTrackingOrder related information
 * which is stored in the database.
 */
@Repository("aio_ptp.VTrackingOrderDao")
public class VTrackingOrderDao extends WMGenericDaoImpl<VTrackingOrder, String> {
