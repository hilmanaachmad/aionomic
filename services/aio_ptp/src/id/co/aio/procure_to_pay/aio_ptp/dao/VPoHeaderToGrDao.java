...
/**
 * Specifies methods used to obtain and modify VPoHeaderToGr related information
 * which is stored in the database.
 */
@Repository("aio_ptp.VPoHeaderToGrDao")
public class VPoHeaderToGrDao extends WMGenericDaoImpl<VPoHeaderToGr, Integer> {
