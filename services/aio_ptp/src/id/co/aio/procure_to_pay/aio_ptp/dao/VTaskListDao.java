...
/**
 * Specifies methods used to obtain and modify VTaskList related information
 * which is stored in the database.
 */
@Repository("aio_ptp.VTaskListDao")
public class VTaskListDao extends WMGenericDaoImpl<VTaskList, Integer> {
