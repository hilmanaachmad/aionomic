...
/**
 * Specifies methods used to obtain and modify TblMDivision related information
 * which is stored in the database.
 */
@Repository("aio_ptp.TblMDivisionDao")
public class TblMDivisionDao extends WMGenericDaoImpl<TblMDivision, Integer> {
