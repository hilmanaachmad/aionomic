...
/**
 * Specifies methods used to obtain and modify VRfqToPo related information
 * which is stored in the database.
 */
@Repository("aio_ptp.VRfqToPoDao")
public class VRfqToPoDao extends WMGenericDaoImpl<VRfqToPo, Integer> {
