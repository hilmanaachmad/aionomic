...
/**
 * Specifies methods used to obtain and modify TblMBrand related information
 * which is stored in the database.
 */
@Repository("aio_ptp.TblMBrandDao")
public class TblMBrandDao extends WMGenericDaoImpl<TblMBrand, Integer> {
