...
/**
 * Specifies methods used to obtain and modify TblTPoHistory related information
 * which is stored in the database.
 */
@Repository("aio_ptp.TblTPoHistoryDao")
public class TblTPoHistoryDao extends WMGenericDaoImpl<TblTPoHistory, Integer> {
