...
/**
 * Specifies methods used to obtain and modify VRfqVendorTop related information
 * which is stored in the database.
 */
@Repository("aio_ptp.VRfqVendorTopDao")
public class VRfqVendorTopDao extends WMGenericDaoImpl<VRfqVendorTop, Integer> {
