...
/**
 * Specifies methods used to obtain and modify TblTPoLineItem related information
 * which is stored in the database.
 */
@Repository("aio_ptp.TblTPoLineItemDao")
public class TblTPoLineItemDao extends WMGenericDaoImpl<TblTPoLineItem, Integer> {
