...
/**
 * Specifies methods used to obtain and modify VActiveBudget related information
 * which is stored in the database.
 */
@Repository("aio_ptp.VActiveBudgetDao")
public class VActiveBudgetDao extends WMGenericDaoImpl<VActiveBudget, Integer> {
