...
/**
 * Specifies methods used to obtain and modify TlMsVe related information
 * which is stored in the database.
 */
@Repository("aio_ptp.TlMsVeDao")
public class TlMsVeDao extends WMGenericDaoImpl<TlMsVe, Integer> {
