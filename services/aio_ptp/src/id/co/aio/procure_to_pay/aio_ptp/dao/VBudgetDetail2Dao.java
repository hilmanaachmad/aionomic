...
/**
 * Specifies methods used to obtain and modify VBudgetDetail2 related information
 * which is stored in the database.
 */
@Repository("aio_ptp.VBudgetDetail2Dao")
public class VBudgetDetail2Dao extends WMGenericDaoImpl<VBudgetDetail2, Integer> {
