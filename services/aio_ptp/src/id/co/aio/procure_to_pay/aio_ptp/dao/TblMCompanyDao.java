...
/**
 * Specifies methods used to obtain and modify TblMCompany related information
 * which is stored in the database.
 */
@Repository("aio_ptp.TblMCompanyDao")
public class TblMCompanyDao extends WMGenericDaoImpl<TblMCompany, Integer> {
