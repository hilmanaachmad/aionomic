...
/**
 * VItemDelivered generated by WaveMaker Studio.
 */
@Entity
@Table(name = "`v_item_delivered`")
public class VItemDelivered implements Serializable {
    ...
    @Column(name = "`delivered`", nullable = true, scale = 4, precision = 21)
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VItemDelivered)) return false;
        final VItemDelivered vitemDelivered = (VItemDelivered) o;
        return Objects.equals(getId(), vitemDelivered.getId());
    }
