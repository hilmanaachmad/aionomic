...
/**
 * Specifies methods used to obtain and modify TblTPo related information
 * which is stored in the database.
 */
@Repository("aio_ptp.TblTPoDao")
public class TblTPoDao extends WMGenericDaoImpl<TblTPo, Integer> {
