...
/**
 * Specifies methods used to obtain and modify VItemDelivered related information
 * which is stored in the database.
 */
@Repository("aio_ptp.VItemDeliveredDao")
public class VItemDeliveredDao extends WMGenericDaoImpl<VItemDelivered, Integer> {
