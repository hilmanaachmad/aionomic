...
/**
 * Specifies methods used to obtain and modify TblTRfqVendor related information
 * which is stored in the database.
 */
@Repository("aio_ptp.TblTRfqVendorDao")
public class TblTRfqVendorDao extends WMGenericDaoImpl<TblTRfqVendor, Integer> {
