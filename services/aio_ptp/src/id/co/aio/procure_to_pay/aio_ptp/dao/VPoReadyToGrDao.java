...
/**
 * Specifies methods used to obtain and modify VPoReadyToGr related information
 * which is stored in the database.
 */
@Repository("aio_ptp.VPoReadyToGrDao")
public class VPoReadyToGrDao extends WMGenericDaoImpl<VPoReadyToGr, Integer> {
