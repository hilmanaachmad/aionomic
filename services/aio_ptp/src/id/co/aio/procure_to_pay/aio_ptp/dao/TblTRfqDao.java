...
/**
 * Specifies methods used to obtain and modify TblTRfq related information
 * which is stored in the database.
 */
@Repository("aio_ptp.TblTRfqDao")
public class TblTRfqDao extends WMGenericDaoImpl<TblTRfq, Integer> {
