...
/**
 * Specifies methods used to obtain and modify VUserRole related information
 * which is stored in the database.
 */
@Repository("aio_ptp.VUserRoleDao")
public class VUserRoleDao extends WMGenericDaoImpl<VUserRole, Integer> {
