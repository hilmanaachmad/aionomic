...
/**
 * Specifies methods used to obtain and modify VGoodsRfq related information
 * which is stored in the database.
 */
@Repository("aio_ptp.VGoodsRfqDao")
public class VGoodsRfqDao extends WMGenericDaoImpl<VGoodsRfq, Integer> {
