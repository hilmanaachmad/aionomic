...
/**
 * Specifies methods used to obtain and modify VPurchaseOrder related information
 * which is stored in the database.
 */
@Repository("aio_ptp.VPurchaseOrderDao")
public class VPurchaseOrderDao extends WMGenericDaoImpl<VPurchaseOrder, Integer> {
