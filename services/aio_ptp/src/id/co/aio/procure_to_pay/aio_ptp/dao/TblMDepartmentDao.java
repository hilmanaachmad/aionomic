...
/**
 * Specifies methods used to obtain and modify TblMDepartment related information
 * which is stored in the database.
 */
@Repository("aio_ptp.TblMDepartmentDao")
public class TblMDepartmentDao extends WMGenericDaoImpl<TblMDepartment, Integer> {
