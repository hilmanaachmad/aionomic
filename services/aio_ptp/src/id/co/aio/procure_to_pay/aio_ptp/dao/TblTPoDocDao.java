...
/**
 * Specifies methods used to obtain and modify TblTPoDoc related information
 * which is stored in the database.
 */
@Repository("aio_ptp.TblTPoDocDao")
public class TblTPoDocDao extends WMGenericDaoImpl<TblTPoDoc, Integer> {
