...
/**
 * Specifies methods used to obtain and modify TblTDelegation related information
 * which is stored in the database.
 */
@Repository("aio_ptp.TblTDelegationDao")
public class TblTDelegationDao extends WMGenericDaoImpl<TblTDelegation, Integer> {
