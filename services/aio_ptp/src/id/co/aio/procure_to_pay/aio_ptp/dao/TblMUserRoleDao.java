...
/**
 * Specifies methods used to obtain and modify TblMUserRole related information
 * which is stored in the database.
 */
@Repository("aio_ptp.TblMUserRoleDao")
public class TblMUserRoleDao extends WMGenericDaoImpl<TblMUserRole, Integer> {
