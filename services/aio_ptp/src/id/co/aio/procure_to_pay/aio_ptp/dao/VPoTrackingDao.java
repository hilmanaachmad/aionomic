...
/**
 * Specifies methods used to obtain and modify VPoTracking related information
 * which is stored in the database.
 */
@Repository("aio_ptp.VPoTrackingDao")
public class VPoTrackingDao extends WMGenericDaoImpl<VPoTracking, Integer> {
