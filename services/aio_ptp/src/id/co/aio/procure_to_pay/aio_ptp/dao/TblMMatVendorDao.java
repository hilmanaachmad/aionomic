...
/**
 * Specifies methods used to obtain and modify TblMMatVendor related information
 * which is stored in the database.
 */
@Repository("aio_ptp.TblMMatVendorDao")
public class TblMMatVendorDao extends WMGenericDaoImpl<TblMMatVendor, Integer> {
