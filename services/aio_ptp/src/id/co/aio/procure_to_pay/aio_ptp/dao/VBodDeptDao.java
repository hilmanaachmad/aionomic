...
/**
 * Specifies methods used to obtain and modify VBodDept related information
 * which is stored in the database.
 */
@Repository("aio_ptp.VBodDeptDao")
public class VBodDeptDao extends WMGenericDaoImpl<VBodDept, String> {
