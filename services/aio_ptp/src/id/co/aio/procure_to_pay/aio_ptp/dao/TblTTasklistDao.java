...
/**
 * Specifies methods used to obtain and modify TblTTasklist related information
 * which is stored in the database.
 */
@Repository("aio_ptp.TblTTasklistDao")
public class TblTTasklistDao extends WMGenericDaoImpl<TblTTasklist, Integer> {
