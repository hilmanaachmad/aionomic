...
/**
 * Specifies methods used to obtain and modify VGrTracking related information
 * which is stored in the database.
 */
@Repository("aio_ptp.VGrTrackingDao")
public class VGrTrackingDao extends WMGenericDaoImpl<VGrTracking, Integer> {
