...
/**
 * Specifies methods used to obtain and modify RelDelAuth related information
 * which is stored in the database.
 */
@Repository("aio_ptp.RelDelAuthDao")
public class RelDelAuthDao extends WMGenericDaoImpl<RelDelAuth, RelDelAuthId> {
