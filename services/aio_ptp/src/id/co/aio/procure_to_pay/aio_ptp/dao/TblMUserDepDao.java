...
/**
 * Specifies methods used to obtain and modify TblMUserDep related information
 * which is stored in the database.
 */
@Repository("aio_ptp.TblMUserDepDao")
public class TblMUserDepDao extends WMGenericDaoImpl<TblMUserDep, Integer> {
