...
/**
 * Specifies methods used to obtain and modify VAlreadyInGr related information
 * which is stored in the database.
 */
@Repository("aio_ptp.VAlreadyInGrDao")
public class VAlreadyInGrDao extends WMGenericDaoImpl<VAlreadyInGr, String> {
