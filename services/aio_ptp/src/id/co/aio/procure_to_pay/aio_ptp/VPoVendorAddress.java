...
/**
 * VPoVendorAddress generated by WaveMaker Studio.
 */
@Entity
@Table(name = "`v_po_vendor_address`")
public class VPoVendorAddress implements Serializable {
    ...
    @Column(name = "`rfqvSalesPerson`", nullable = true, length = 2147483647)
    ...
    @Column(name = "`rfqvSalesNumber`", nullable = true, length = 20)
    ...
    @Column(name = "`rfqvSalesEmail`", nullable = true, length = 100)
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VPoVendorAddress)) return false;
        final VPoVendorAddress vpoVendorAddress = (VPoVendorAddress) o;
        return Objects.equals(getId(), vpoVendorAddress.getId());
    }
