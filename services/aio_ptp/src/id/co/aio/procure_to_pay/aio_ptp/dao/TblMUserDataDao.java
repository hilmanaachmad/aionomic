...
/**
 * Specifies methods used to obtain and modify TblMUserData related information
 * which is stored in the database.
 */
@Repository("aio_ptp.TblMUserDataDao")
public class TblMUserDataDao extends WMGenericDaoImpl<TblMUserData, Integer> {
