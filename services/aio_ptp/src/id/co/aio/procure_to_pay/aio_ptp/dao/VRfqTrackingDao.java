...
/**
 * Specifies methods used to obtain and modify VRfqTracking related information
 * which is stored in the database.
 */
@Repository("aio_ptp.VRfqTrackingDao")
public class VRfqTrackingDao extends WMGenericDaoImpl<VRfqTracking, Integer> {
