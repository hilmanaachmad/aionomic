...
/**
 * Specifies methods used to obtain and modify TblTPrHistory related information
 * which is stored in the database.
 */
@Repository("aio_ptp.TblTPrHistoryDao")
public class TblTPrHistoryDao extends WMGenericDaoImpl<TblTPrHistory, Integer> {
