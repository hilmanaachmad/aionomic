 ...
 * @see TlMsVe
 */
@Service("aio_ptp.TlMsVeService")
@Validated
@EntityService(entityClass = TlMsVe.class, serviceId = "aio_ptp")
public class TlMsVeServiceImpl implements TlMsVeService {
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service aio_ptp for table TlMsVe to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service aio_ptp for table TlMsVe to {} format", options.getExportType());
