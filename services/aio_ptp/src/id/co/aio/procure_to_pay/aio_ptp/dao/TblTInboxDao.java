...
/**
 * Specifies methods used to obtain and modify TblTInbox related information
 * which is stored in the database.
 */
@Repository("aio_ptp.TblTInboxDao")
public class TblTInboxDao extends WMGenericDaoImpl<TblTInbox, Integer> {
