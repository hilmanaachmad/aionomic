...
/**
 * Specifies methods used to obtain and modify TblMIo related information
 * which is stored in the database.
 */
@Repository("aio_ptp.TblMIoDao")
public class TblMIoDao extends WMGenericDaoImpl<TblMIo, Integer> {
