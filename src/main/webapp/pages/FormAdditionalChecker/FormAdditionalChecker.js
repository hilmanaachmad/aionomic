...
Page.buttonApproveClick = function($event, widget) {
    Promise.resolve().then(() => {
        ...
        console.log("task 1")
        var userId;
        let data = Page.Variables.vmAdditionalModel.dataSet;
        if (data.repNik) {
            userId = data.repNik;
            Page.Variables.mCreatorName.dataSet = data.repName;
        } else {
            userId = data.baCreatedId;
            Page.Variables.mCreatorName.dataSet = data.baCreatedBy;
        }
        ...
        var subject = "3000-" + Page.Variables.vmAdditionalModel.dataSet.baId;
        ...
        var dataSet = {
            ...
            "tlParamId": Page.Variables.vmAdditionalModel.dataSet.baId,
        ...
        return Page.Variables.dbTblTInbox.createRecord({
            row: {
                ...
                "userId": Page.Variables.mSupervisorNik.dataSet,
